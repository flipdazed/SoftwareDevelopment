        ...
        if money > 0:
            ...
            while cb:
                ...
                if len(templist) >0:
                    ...
                    # prioritises on attack (aggressive) or money (acquisitive)
                    ...
                    # set source as the card's source in the active pile
                    # this is the 0 element assigned in the tuple, S or [0,5]
                    source = templist[highestIndex][0]
                    
                    if source in range(0,5): # if source is between 0 and 4
                        
                        # unnecessary comparison has alrady been made.
                    ...
                    else: # if source is not between 0 and 4
